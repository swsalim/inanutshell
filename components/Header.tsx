...
function MobileNavigation(props) {
  return (
    <Popover {...props}>
      <Popover.Button className="group flex items-center rounded-full bg-white/90 px-4 py-2 text-sm font-medium text-stone-800 shadow-lg shadow-stone-800/5 ring-1 ring-stone-900/5 backdrop-blur dark:bg-stone-800/90 dark:text-stone-200 dark:ring-white/10 dark:hover:ring-white/20">
        Menu
          ...
          <Popover.Panel
            ...
            <div className="flex flex-row-reverse items-center justify-between">
              <Popover.Button aria-label="Close menu" className="-m-1 p-1">
                <CloseIcon className="h-6 w-6 text-stone-500 dark:text-stone-300" />
              </Popover.Button>
            ...
            <nav className="mt-6">
              <ul className="-my-2 divide-y divide-stone-100 text-base text-stone-800 dark:divide-stone-100/5 dark:text-stone-300">
                ...
                <MobileNavItem href="/write">Articles</MobileNavItem>
  ...
  return (
    <nav {...props}>
      <ul className="flex rounded-full bg-white/90 px-3 text-sm font-medium text-stone-800 shadow-lg shadow-stone-800/5 ring-1 ring-stone-900/5 backdrop-blur dark:bg-stone-800/90 dark:text-stone-200 dark:ring-white/10">
        ...
        <NavItem href="/write">Articles</NavItem>
...
function ModeToggle() {
  ...
  return (
    <button
      ...
      <MoonIcon className="hidden h-6 w-6 fill-stone-700 stroke-stone-500 transition dark:block [@media(prefers-color-scheme:dark)]:group-hover:stroke-stone-400 [@media_not_(prefers-color-scheme:dark)]:fill-teal-400/10 [@media_not_(prefers-color-scheme:dark)]:stroke-teal-500" />
    </button>
  );
}
  ...
  return (
    <>
      <header
        ...
        style={headerStyle as CSSProperties}>
        {isHomePage && (
          <>
            <div
              ref={avatarRef}
            ...
            />
            <Container
              className="relative top-0 order-last -mb-3 pt-3"
              style={headerPosition as CSSProperties}>
              <div
                className="top-[var(--avatar-top,theme(spacing.3))] w-full"
                style={headerInnerPosition as CSSProperties}>
